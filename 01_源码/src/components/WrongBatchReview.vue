...
<template>
  <div v-if="brShow" class="ov show" @click.self="brCancel = true; brShow = false">
    <div class="pnl" style="max-width: 680px">
      ...
      <!-- 范围：板块(组全称) → 细分 → 题型 -->
      <div style="display:flex;gap:6px;flex-wrap:wrap;align-items:center;margin-bottom:8px;font-size: calc(12.5px * var(--ui-fs-scale, 1))">
      ...
      <div style="display: flex; gap: 6px; flex-wrap: wrap; align-items: center; margin-bottom: 8px">
        <span style="font-size: calc(13px * var(--ui-fs-scale, 1))">每次最多复盘：</span>
        <button class="btn btn-gh" style="padding: 4px 10px; font-size: calc(12px * var(--ui-fs-scale, 1))" @click="brPick(5)">5 题</button>
        <button class="btn btn-gh" style="padding: 4px 10px; font-size: calc(12px * var(--ui-fs-scale, 1))" @click="brPick(10)">10 题</button>
        <button class="btn btn-gh" style="padding: 4px 10px; font-size: calc(12px * var(--ui-fs-scale, 1))" @click="brPick(15)">15 题</button>
        <button class="btn btn-gh" style="padding: 4px 10px; font-size: calc(12px * var(--ui-fs-scale, 1))" @click="brPick(20)">20 题</button>
      </div>
